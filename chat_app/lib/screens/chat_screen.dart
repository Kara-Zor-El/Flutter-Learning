...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _callPhone(String num) async {
    String url = 'tel://$num';
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      Fluttertoast.showToast(
          msg: 'Nothing to send', backgroundColor: AppColors.overlay1);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text('Chat with ${widget.peerNickname}'.trim()),
        actions: [
          IconButton(
            onPressed: () {
            ...
            Row(
              ...
              children: [
                chatMessages.type == MessageType.text
                    ? messageBubble(
                        chatMessage: chatMessages.content,
                        color: AppColors.overlay1,
